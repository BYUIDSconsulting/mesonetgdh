...
```r
myconn <- DBI::dbConnect(odbc::odbc(), "Stotz", uid = "STOTZ_GUEST",
                         pwd = "a9rf8vFBhjnfaHSighs")
```

Then, try using the farm production database (this should return a data frame with zero rows and columns):
